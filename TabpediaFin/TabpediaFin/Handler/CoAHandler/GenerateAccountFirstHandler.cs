        ...
        public async Task<PagedListResponse<AccountListDto>> Handle(GenerateAccountInsertDto request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                listofAccount.AddRange(new List<Account>
                {
                    ...
                    new Account("Piutang Karyawan", "1-10200", 4, 0, 0, "", 0, false, _currentUser.TenantId, _currentUser.UserId),
                    ...
                    new Account("Pendapatan Jasa", "4-40000", 11, 0, 0, "", 0, true, _currentUser.TenantId, _currentUser.UserId),
