...
public class Table_Item : Migration
{
    ...
    public override void Up()
    {
        Create.Table("Item")
            ...
            .WithColumn("PurchaseTax").AsInt32().NotNullable().WithDefaultValue(0)
            .WithColumn("SalesAccount").AsInt32().NotNullable().WithDefaultValue(0)
            .WithColumn("SalesTax").AsInt32().NotNullable().WithDefaultValue(0)
            .WithColumn("StockAccount").AsInt32().NotNullable().WithDefaultValue(0)
