...
{
    public class ContactPersonFetchHandler : IFetchByIdHandler<ContactPersonFetchDto>
    {
        ...
        public async Task<RowResponse<ContactPersonFetchDto>> Handle(FetchByIdRequestDto<ContactPersonFetchDto> request, CancellationToken cancellationToken)
        {
